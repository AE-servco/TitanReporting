...
def fetch_jobs(
    ...
    while True:
        ...
        if not isinstance(resp, dict):
            break
        page_data: Iterable[Dict[str, Any]] = resp.get("data") or resp.get("items") or []
...
def main() -> None:
    ...
    with st.sidebar:
        ...
        # patch_url = st.text_input(
        #     "Patch URL", value="https://api.servicetitan.io/your/endpoint", help="Endpoint to send checkbox data"
        # )
